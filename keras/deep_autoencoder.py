...
decoded = Dense(encoding_dim2, activation='sigmoid')(encoded)
decoded = Dense(encoding_dim1, activation='sigmoid')(decoded)
...
decoder_out_layer = autoencoder.layers[-1] # for one layer autodecoders
decoder = Model(encoded_input, decoder_out_layer(encoded_input))
